...
export const AppointmentsList: React.FC<AppointmentsListProps> = ({ 
  ...
  return (
    <div>
      {/* Column Headers - STICKY at top, horizontal scroll */}
      <div className="md:grid overflow-x-auto overflow-y-hidden scrollbar-hide items-center mb-1 text-xs md:text-sm lg:text-base font-bold text-[#A6AFC2] font-gilroy bg-[#EDF0F8] py-2 px-0 appointment-header-grid mx-8 sticky top-0 z-[99]">
        ...
        <div className="flex items-center px-3 py-2">
          <span className="hidden md:inline">Wallet bal. (₦)</span>
        </div>
      ...
      {/* Cards scroll container - ONLY this scrolls */}
      <div className="h-[calc(100vh-220px)] overflow-y-auto z-0 mx-8 scrollbar-hide">
        {/* Appointment Cards List */}
        <div className="flex flex-col gap-2 p-4 md:p-0 min-w-full md:min-w-0">
