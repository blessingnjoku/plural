    ...
    <>
      ...
      <div className="hidden md:block">
        <div
          ...
          className={`group relative border border-gray-100 rounded-[10px] mb-2 lg:mb-3 shadow-sm hover:shadow-md transition-all cursor-pointer overflow-hidden appointment-card-grid ${
            index === 0
              ? "bg-[#DFE2E9]"
              : isSelected
              ? "bg-[#DFE2E9]"
