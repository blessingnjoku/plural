...
import { Button, SearchInput, Icon, IconPresets } from '../ui'
import { HamburgerMenu } from '../navigation'
import { SortModal, type SortOption, ClinicFilterModal, type ClinicType } from '../shared'
  ...
  return (
    <div className="space-y-2 mx-8">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6 pt-6 pb-[8px]">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-[62px] w-full md:w-auto">
          {/* Title */}
          <h1 className="text-[18px] md:text-heading-2 font-bold text-[#051438]">
            Appointments
          </h1>

          {/* Clinic Filter Dropdown */}
          <div className="relative hidden md:block" ref={clinicRef}>
            <button
              onClick={() => setClinicOpen(!clinicOpen)}
              className="flex items-center gap-2 px-3 py-2 text-base font-semibold font-gilroy text-[#051438] hover:opacity-80 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-700 rounded-md"
            >
              All clinics
              <svg
          ...
          <div className="relative hidden md:block" ref={sortRef}>
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-base font-semibold font-gilroy text-[#0B0C7D] hover:opacity-80 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-700 rounded-md"
            >
